...
export const spiritSpells: SpiritSpell[] = [
    {
        ...
        description: `
            ...
            INT×5 (due to the confusion of thought processes, where
            ...
            If the INT×5 roll results in a special or critical success,
...

    {
        ...
        description: `
            ...
            of Fanaticism (33÷2=17, 33+17=50%). /n
...

    {
        ...
        description: `
            ...
            equal to their POW×5. The user also needs to spend 1
