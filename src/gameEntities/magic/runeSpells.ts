import {RuneSpell} from "./types";
import {RuneElementalTitle, RuneFormTitle, RunePowerTitle} from "../gameEntitiesTypes";
import {OtherRunes} from "../runes/otherRunes";


export const runeSpells: RuneSpell[] = [
    {
        title: 'Absorption',
...

    {
        ...
        description: `
            ...
            rolling INT×1 or successful use of the Meditate skill (pick
            ...
            Arroy initiate’s CHA×5. This ability does not extend to the
...

    {
        ...
        description: `
            ...
            roll DEX×3 or fall into it, taking 1D6 falling damage per
...

    {
        ...
        description: `
            ...
            9×6×6 meters or any other shape with the same volume. It
...

    {
        ...
        description: `
            ...
            than the caster’s POW×5, then the caster failed to interpret
...

    {
        ...
        description: `
            ...
            must make a CON×5 roll or die as above. /n
...

    {
        ...
        description: `
            ...
            the odor to make a CON×2 roll against the odor. Failure
...

    {
        ...
        description: `
            ...
            and DEX rolls. Each round, anyone standing up must succeed in a DEX×5 roll or fall (this roll is modified by the
            above penalty). /n
...

    {
        ...
        description: `
            ...
            A small elemental is 1 cubic meter in size or less (1×1×1).
            With one additional Rune point stacked with this spell, a
            medium elemental is summoned. A medium elemental is
            3 cubic meters or less (1×3×1). With two additional points
            stacked with this spell, a large elemental is summoned. A
            large elemental is 10 cubic meters or less (2×5×1). Most cults
...

    {
        ...
        description: `
            ...
            skill equal to its POW×5 and no spells. If the
