import {characterRunesReducer, defaultCharacterRunesState} from "./characterRunesStore/characterRunesStore.js";
import {
  ADJUST_CHARACTERISTICS,
  SET_CHARACTERISTICS,
  SET_HOMELAND_TITLE,
  SET_PASSIONS
...
} from "../stepsStore/stepsActions.js";
import {AFFINITY_RUNE_CHAR_BONUS_PRIMARY, AFFINITY_RUNE_CHAR_BONUS_SECONDARY} from "../../gameEntities/rules.js";
...
export const characterReducer = (state = defaultCharacterState, action) => {
  ...
  switch (action.type) {
    ...
    case ADJUST_CHARACTERISTICS:
      ...
      Object.keys(action.payload).forEach((charKey) => newCharacteristics[charKey] += action.payload[charKey]);
      return {
        ...state,
        characteristics: {
          ...newCharacteristics
